...
<body>
  <form>
    ...
    <div>
      ...
      <input type="password" id="inputPassword" aria-describedby="passwordHelp" placeholder="Password" required>
    </div>
    <div>
      <label for="inputPhoneNumber">Phone number</label>
      <input type="tel" id="inputPhoneNumber" aria-describedby="phoneNumberHelp">
    </div>
    <div>
      <input type="checkbox" id="checkNewsLetter" aria-describedby="newsLetterHelp" required>
      <label for="checkNewsLetter">Newsletter</label>
    </div>
    <button type="submit" aria-describedby="submitButtonHelp">Submit</button>
  </form>
</body>
</html>
